...
export const CandidateDetailModal: React.FC<CandidateDetailModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'experience' | 'interview' | 'qa'>('overview');
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pr-8">
            ...
            <div className="flex items-center gap-3 bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm shrink-0">
              ...
              <button
                ...
                className="p-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-colors flex items-center gap-1"
